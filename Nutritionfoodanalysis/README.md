...
Noaii adalah aplikasi chatbot cerdas berbasis Android yang menggabungkan kemampuan **Groq AI (Llama 3.1 8B)** dan **USDA Food Database** untuk memberikan analisis nutrisi makanan secara instan dan interaktif.
...
---
*Dikembangkan dengan ❤️ untuk gaya hidup sehat yang lebih cerdas.*
